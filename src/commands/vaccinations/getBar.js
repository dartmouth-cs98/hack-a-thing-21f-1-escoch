...
export default async (
	...
	if (!countryName && bar) {
		...
		const statesURL = `https://disease.sh/v3/covid-19/vaccine/coverage/states?lastdays=${1}&fullData=true`;
		const countriesURL = `https://disease.sh/v3/covid-19/vaccine/coverage/countries?lastdays=${1}&fullData=true`;
